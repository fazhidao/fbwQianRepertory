...
<div>
	...
	<view class="indentify_form_box">
		...
		<view class="indentify_row">
			<view class="indentify_row_title">企业名称：</view>
			<input-box classes="indentify_row_input" v-model="name" placeholder="请输入企业名称" @clear="name=''"></input-box>
		</view>
		...
		<view class="indentify_row">
			<view class="indentify_row_title">企业规模(人)：</view>
			<input-box classes="indentify_row_input" v-model="scale" placeholder="请输入大致企业人数" @clear="scale=''"></input-box>
		</view>
		<view class="borderY"></view>
		
		<view class="indentify_row">
			<view class="indentify_row_title">营业执照：</view>
		</view>
	...
	export default{
		...
		methods:{
			...
			checkInfo(){
				...
				uni.uploadFile({
					url: this.ServerUrl+'users/company_license',
